...
public enum ModArmorMaterials implements ArmorMaterial {
    NEOGEUM("neogeum", 33, Util.make(new EnumMap<>(ArmorItem.Type.class), (p_266655_) -> {
        p_266655_.put(ArmorItem.Type.BOOTS, 4);
        p_266655_.put(ArmorItem.Type.LEGGINGS, 6);
        p_266655_.put(ArmorItem.Type.CHESTPLATE, 8);
        p_266655_.put(ArmorItem.Type.HELMET, 4);
    }), 15, SoundEvents.ARMOR_EQUIP_NETHERITE, 2.5F, 0.0F, () -> Ingredient.of(ModItems.NEOGEUM.get())),

    ROSE_QUARTZ("rose_quartz", 33, Util.make(new EnumMap<>(ArmorItem.Type.class), (p_266656_) -> {
    ...
    }), 15, SoundEvents.ARMOR_EQUIP_NETHERITE, 2.5F, 0.0F, () -> Ingredient.of(ModItems.ROSEQUARTZ.get()));
    ...
    public String getName() {
        return Neogeum.MOD_ID + ":" + this.name;
    }
