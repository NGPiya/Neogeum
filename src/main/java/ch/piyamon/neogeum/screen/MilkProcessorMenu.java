...
public class MilkProcessorMenu extends AbstractContainerMenu {
    public final MilkProcessorBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public MilkProcessorMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.MILK_PROCESSOR.get());
    }
